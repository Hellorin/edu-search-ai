...
/**
 * In-memory implementation of a repository specifically for course objectives documents.
 ...
 */
@Repository
public class InMemoryCourseObjectivesDocumentRepository extends DocumentRepository {
    ...
    public InMemoryCourseObjectivesDocumentRepository(MathComponent mathComponent) {
        super(mathComponent);
    }
